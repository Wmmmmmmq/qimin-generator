...
import com.qimin.maker.template.model.TemplateMakerConfig;
...
import com.qimin.maker.template.model.TemplateMakerOutputConfig;
...
public class TemplateMaker {
    ...
    public static long makeTemplate(Meta newMeta, String originProjectPath,
        ...
        // 处理模型信息
        List<Meta.ModelConfig.ModelsInfo> newModelsInfoList = getModelsInfoList(templateMakerModelConfig);
    ...
    private static List<Meta.ModelConfig.ModelsInfo> getModelsInfoList(TemplateMakerModelConfig templateMakerModelConfig) {
        // 本次新增的模型配置列表
        ...
        if (modelGroupConfig != null) {
            ...
            BeanUtil.copyProperties(modelGroupConfig, groupModelsInfo);
