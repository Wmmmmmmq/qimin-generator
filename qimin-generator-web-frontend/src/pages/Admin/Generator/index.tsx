...
import React, { Generatoref, useState } from 'react';
...
const GeneratorAdminPage: React.FC = () => {
  ...
  const actionRef = Generatoref<ActionType>();
  // 当前用户点击的数据
